...
function OnGUI() {
    ...
    while (GUI.RepeatButton(new Rect(Screen.width*0.0,Screen.height*0.9,Screen.width*0.1,Screen.height*0.1), "Left") ){
        transform.Translate(LeftSpeed,0,0);
            
    } 
    while (GUI.RepeatButton(new Rect(Screen.width*0.9,Screen.height*0.9,Screen.width*0.1,Screen.height*0.1), "Right") ){
